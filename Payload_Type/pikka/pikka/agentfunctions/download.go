...
var download = agentstructs.Command{
	...
	AssociatedBrowserScript: &agentstructs.BrowserScript{
		ScriptPath: filepath.Join(".", "pikka", "browserscripts", "download_new.js"), // the name of the script in agent_browser_scripts
...
func init() {
	agentstructs.AllPayloadData.Get("pikka").AddCommand(download)
}
